...
var control1 = [[-5,0,-1],[-5,0,-25],[0,0,0],[0,0,0]];
var control2 = [[9,0,-1],[9,0,-25],[0,0,0],[0,0,0]];
var c11 = CUBIC_HERMITE(S0)(control1);
var c12 = CUBIC_HERMITE(S0)(control2);
var s1 = BEZIER(S1)([c11,c12])
var surface1 = COLOR([0,0,0])(MAP(s1)(domain2));
var line = COLOR([228/255, 219/255, 197/255])(CUBOID([0.3,0.1,24]))
var lineT = T([0,2])([1.5,-25])(line)
DRAW(lineT)
DRAW(surface1); 

var controlG1 = [[-5,0,-25],[-5,0,-30],[0,0,0],[0,0,0]];
var controlG2 = [[9,0,-25],[9,0,-30],[0,0,0],[0,0,0]];
var c11 = CUBIC_HERMITE(S0)(controlG1);
var c12 = CUBIC_HERMITE(S0)(controlG2);
var sand1 = BEZIER(S1)([c11,c12])
var surfaceSand1 = COLOR([210/255, 173/255 ,107/255])(MAP(sand1)(domain2));
DRAW(surfaceSand1)
